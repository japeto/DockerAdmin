...
class containerModel { 
    ...
    public function getContainerList($args){  
		...
		if($output==1 && $args=='')return new Notification(notificationType::Info,'Advertencia!', 'No hay contenedores en ejecucion en @'.$this->settings->host.':'.$this->settings->port);
